                            ...
                            <ul class="nav-top-list">
                                <li id="nav-about-item" class="nav-item dropdown">
                                    ...
                                    <ul id="nav-about-dropdown" class="dropdown-menu">
                                        ...
                                        <li><a id="nav-about-services" href="#about5">Bilgi Toplumu Hizmetleri</a></li>
                ...
                <div class="nav-bottom">
                    <ul class="nav-bottom-list">
                        ...
                        <li id="nav-bottom-solutions-item" class="nav-item dropdown">
                            <a id="nav-bottom-solutions-link" href="#Solutions" class="nav-link">DRD Çözümleri<i class="fas fa-chevron-down"></i></a>
                            <ul id="nav-bottom-solutions-dropdown" class="dropdown-menu">
                                <li><a id="nav-bottom-solutions-fleetino" href="#Solutions1">Fleetino</a></li>
                                <li><a id="nav-bottom-solutions-shared" href="#Solutions2">Paylaşımlı Filo</a></li>
                            </ul>
                        </li>
                        <li id="nav-bottom-vehicles-item" class="nav-item dropdown">
                            <a id="nav-bottom-vehicles-link" href="#Vehicles" class="nav-link">Araçlar<i class="fas fa-chevron-down"></i></a>
                            <ul id="nav-bottom-vehicles-dropdown" class="dropdown-menu">
                                <li><a id="nav-bottom-vehicles-listing" href="#Vehicles1">Araç Listele</a></li>
                                <li><a id="nav-bottom-vehicles-brands" href="#Vehicles2">Markalar</a></li>
                                <li><a id="nav-bottom-vehicles-electric" href="#Vehicles3">Elektrikli Araçlar</a></li>
                                <li><a id="nav-bottom-vehicles-campaigns" href="#Vehicles4">Kampanyalar</a></li>
                            </ul>
                        </li>
                        <li id="nav-bottom-offer-item" class="nav-item">
                            <a id="nav-bottom-offer-link" href="#GetOffer" class="nav-link">Teklif Al</a>
                        </li>
                        <li id="nav-bottom-support-item" class="nav-item dropdown">
                            <a id="nav-bottom-support-link" href="#Support" class="nav-link">Destek & İletişim<i class="fas fa-chevron-down"></i></a>
                            <ul id="nav-bottom-support-dropdown" class="dropdown-menu">
                                <li><a id="nav-bottom-support-faq" href="#Support1">Sıkça Sorulan Sorular</a></li>
                                <li><a id="nav-bottom-support-contact" href="#Support2">İletişim</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
