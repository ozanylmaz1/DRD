class NewsComponent {
        ...
        return `
            <section class="news">
                <div class="section-head">
                    ...
                    <a id="news-listing-link" href="news.html">
                        Listele
    ...
    initEventHandlers() {
        ...
        const newsListingLink = document.getElementById('news-listing-link');
        if (newsListingLink) {
            newsListingLink.addEventListener('click', (e) => {
                e.preventDefault();
                console.log('News listing link clicked');
                // Burada haberler sayfasına yönlendirme yapılabilir
        ...
        newsCards.forEach((card, index) => {
            card.addEventListener('click', (e) => {
                e.preventDefault();
                console.log(`News card ${index + 1} clicked`);
                // Burada ilgili haber detay sayfasına yönlendirme yapılabilir
