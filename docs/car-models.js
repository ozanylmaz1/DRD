        ...
        return `
            <section id="car-models-section" class="car-models">
                <div id="car-models-head" class="section-head">
                    ...
                    <a id="car-models-listing-link" href=".html">
                        Listele
                ...
                <div id="car-models-main" class="car-models-main">
                    ...
                    <a id="car-card-2" href="car2">
                        <img id="car-image-2" src="https://drdcmsv2.taigalab.com/Files/img/CarImages/2025/alfa-romeo-tonale-ti-16-diesel-130-dct/alfa-romeo-tonale-ti-16-diesel-130-dct-1.jpg"
                             alt="Alfa-Romeo-Tonale-Veloce-Hybrid-eAWD" />
                    ...
                    <a id="car-card-3" href="car3">
                        <img id="car-image-3" src="https://drdcmsv2.taigalab.com/Files/img/CarImages/2025/alfa-romeo-tonale-ti-16-diesel-130-dct/alfa-romeo-tonale-ti-16-diesel-130-dct-1.jpg"
                             alt="Alfa-Romeo-Tonale-Veloce-Hybrid-eAWD" />
                    ...
                    <a id="car-card-4" href="car4">
                        <img id="car-image-4" src="https://drdcmsv2.taigalab.com/Files/img/CarImages/2025/alfa-romeo-tonale-ti-16-diesel-130-dct/alfa-romeo-tonale-ti-16-diesel-130-dct-1.jpg"
                             alt="Alfa-Romeo-Tonale-Veloce-Hybrid-eAWD" />
                    ...
                    <a id="car-card-5" href="car5">
                        <img id="car-image-5" src="https://drdcmsv2.taigalab.com/Files/img/CarImages/2025/audi-a6-40-20-tdi-quattro-204-design-s-tronic/audi-a6-40-20-tdi-quattro-204-design-s-tronic-1.jpg"
                        ...
                        <p id="car-specifications-5" class="car-specifications">
                            Dizel / Otomatik / Sedan
                        </p>
                    </a>
                    <a id="car-card-6" href="car6">
                        <img id="car-image-6" src="https://drdcmsv2.taigalab.com/Files/img/CarImages/2025/bmw-520d-xdrive-sedan-20-190-m-sport/bmw-520d-xdrive-sedan-20-190-m-sport-1.jpg"
